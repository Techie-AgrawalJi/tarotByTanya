  ...
  return (
    <section id="contact" data-testid="contact-section" className="py-24 relative z-10">
      ...
      <div className="container mx-auto px-4 flex justify-center items-center gap-4 mb-20 opacity-50">
        <div className="w-8 h-8 rounded-full border border-primary flex-shrink-0" />
        <div className="w-8 h-8 rounded-full border border-primary flex-shrink-0 bg-primary/20 relative overflow-hidden">
          <div className="absolute inset-0 bg-primary translate-x-1/2" />
        </div>
        <div className="w-10 h-10 rounded-full bg-primary flex-shrink-0 shadow-[0_0_20px_rgba(201,168,76,0.6)]" />
        <div className="w-8 h-8 rounded-full border border-primary flex-shrink-0 bg-primary/20 relative overflow-hidden">
          <div className="absolute inset-0 bg-primary -translate-x-1/2" />
        </div>
        <div className="w-8 h-8 rounded-full border border-primary flex-shrink-0" />
      ...
      <div className="container mx-auto max-w-4xl px-4">
        <motion.div 
          ...
          viewport={{ once: true }}
          className="glass-card rounded-3xl p-10 md:p-16 text-center relative overflow-hidden border border-white/10"
        >
          ...
          <div className="grid md:grid-cols-2 gap-12 text-left mb-12">
            <div className="space-y-8">
              <a href="mailto:readings@celestialguidance.com" className="flex items-center gap-6 group">
                ...
                <div>
                  ...
                  <div className="text-lg text-white group-hover:text-primary transition-colors">readings@celestialguidance.com</div>
                </div>
              </a>
              ...
              <a href="tel:+917877082223" className="flex items-center gap-6 group">
                ...
                <div>
                  ...
                  <div className="text-lg text-white group-hover:text-primary transition-colors">+91 78770 82223</div>
                </div>
              </a>
              ...
              >
                ...
                <div>
                  ...
                  <div className="text-lg text-white group-hover:text-[#25D366] transition-colors">Chat with us on WhatsApp</div>
                </div>
              </a>
            </div>
            ...
            <div>
              ...
              <div className="flex gap-4">
                ...
                <a href="#" className="w-14 h-14 rounded-full bg-white/5 border border-white/10 flex items-center justify-center hover:bg-[#ff0050] hover:border-[#ff0050] transition-all duration-300 text-foreground hover:text-white group">
                  <SiTiktok className="w-6 h-6 transform group-hover:scale-110 transition-transform" />
                </a>
              </div>
            </div>
          </div>
